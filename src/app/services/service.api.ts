...
*/
	...
	booking2(reserva) {
		let utl = "https://booking.becheckin.com/reserva?hotel/reserva=" + reserva
	...
	sendmail(usuario, reserva, mailTo, start, finish, fast): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/mail", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	sendGenericMail(asunto, mensaje, mailTo, cc?, cco?): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/gmail", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	sendBooking(data, code): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/sendBooking", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	booking(reserva): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/getAllHotels", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	getHotel(hotelId): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/populate", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	getHotelbyId(hotelId): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/gethotelbyid", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	crearllave(data, room): Promise<any> {
		...
		//return this.makePost("https://booking.becheckin.com/keyByCode", data)
		if (room != '0') {
			data.room = room
			console.log('Grabo: ', data)
			return this.makePost("https://booking.becheckin.com/createKey", data)
				.then((response: any) => {
	...
	grabarDatosReserva(reserva): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/datosReserva", reserva)
			.then((response: any) => {
	...
	getpin(data): Promise<any> {
		...
		return this.makePost("https://booking.becheckin.com/setcvc", data)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	getcard(data): Promise<any> {
		return this.makePost("https://booking.becheckin.com/getcard", data)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	grabarCard(data): Promise<any> {
		return this.makePost("https://booking.becheckin.com/cardStripe", data)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	setPin(data): Promise<any> {
		return this.makePost("https://booking.becheckin.com/pin", data)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	getRooms(cliente) {
		...
		return this.makePost("https://booking.becheckin.com/getRooms", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	getClient(user, pass) {
		...
		return this.makePost("https://booking.becheckin.com/getClient", body)
			.then((response: any) => {
				return Promise.resolve(response);
			})
			.catch((response: any) => {
	...
	public crearOcrDniFrontal(text) {
		...
		return this.makePost('https://booking.becheckin.com/ocr/dni/frontal', body)
			.then(res => {
	...
	public crearOcrPasaporte(text) {
		...
		return this.makePost('https://booking.becheckin.com/ocr/pasaporte/', body)
			.then(res => {
				return Promise.resolve(res);
			})
			.catch(error => {
